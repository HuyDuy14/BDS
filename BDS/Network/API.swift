...
class API: NSObject {
    ...
    static var landForSale = "type_land.php"
    ...
    static var getCategoryAdvise = "get_advise_category.php"
    ...
    static var searchLandSale = "search_land_sale.php"
    ...
    static var searchBroker = "search_broker.php"
    ...
    static var getAdvise = "get_advise_by_category.php"
    static var detailSale = "sale_detail.php"
    static var detailProjrect = "project_detail.php"
    static var detailBroker = "broker_detail.php"
    ...
    static var getPrice = "get_price.php"
}
