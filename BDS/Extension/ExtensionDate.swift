...
public extension Date {
    ...
    public func dateFormatStringWithFormat(format:String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
        return dateFormatter.string(from: self)
    }
    
    public func dateFormatStringWithFormatAndLocale(format:String,locale:String) -> String {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = format
    ...
    public func dateFormatDate() -> Date {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd"
